...
static PyCodeObject *code_objects_49e1b7d0b4bc9978aeded24fde08fd2b;
...
static void createModuleCodeObjects(void) {
    ...
    code_objects_49e1b7d0b4bc9978aeded24fde08fd2b = MAKE_CODE_OBJECT(module_filename_obj, 1, 0, mod_consts[23], mod_consts[23], NULL, NULL, 0, 0, 0);
    code_objects_main = code_objects_49e1b7d0b4bc9978aeded24fde08fd2b;
}
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$helper_function_complex_call_helper_pos_star_list_star_dict(PyThreadState *tstate, PyObject **python_pars) {
    ...
    branch_yes_5:;
    {
        ...
        PyObject *tmp_tuple_element_3;
        PyObject *tmp_dircall_arg1_3;
        tmp_mod_expr_left_3 = mod_consts[8];
        if (par_called == NULL) {
...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$helper_function_complex_call_helper_dict_unpacking_checks(PyThreadState *tstate, PyObject **python_pars) {
    ...
    branch_yes_3:;
    {
        ...
        tmp_mod_expr_right_2 = MAKE_TUPLE_EMPTY(tstate, 2);
        {
            ...
            tmp_expression_value_3 = BUILTIN_TYPE1(tmp_type_arg_2);
            assert(!(tmp_expression_value_3 == NULL));
            tmp_tuple_element_2 = LOOKUP_ATTRIBUTE(tstate, tmp_expression_value_3, mod_consts[5]);
            Py_DECREF(tmp_expression_value_3);
            if (tmp_tuple_element_2 == NULL) {
                assert(HAS_ERROR_OCCURRED(tstate));
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_49e1b7d0b4bc9978aeded24fde08fd2b;
    ...
    // Module code.
    {
        ...
        UPDATE_STRING_DICT0(moduledict___main__, (Nuitka_StringObject *)mod_consts[16], tmp_assign_source_1);
    }
    {
        PyObject *tmp_assign_source_2;
    ...
    frame_49e1b7d0b4bc9978aeded24fde08fd2b = MAKE_MODULE_FRAME(code_objects_49e1b7d0b4bc9978aeded24fde08fd2b, module___main__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStackCompiledFrame(tstate, frame_49e1b7d0b4bc9978aeded24fde08fd2b);
    assert(Py_REFCNT(frame_49e1b7d0b4bc9978aeded24fde08fd2b) == 2);
    ...
    // Framed code:
    {
        ...
        frame_49e1b7d0b4bc9978aeded24fde08fd2b->m_frame.f_lineno = 4;
...

    {
        ...
        if (exception_tb == NULL) {
            exception_tb = MAKE_TRACEBACK(frame_49e1b7d0b4bc9978aeded24fde08fd2b, exception_lineno);
            SET_EXCEPTION_STATE_TRACEBACK(&exception_state, exception_tb);
        } else if (exception_tb->tb_frame != &frame_49e1b7d0b4bc9978aeded24fde08fd2b->m_frame) {
            exception_tb = ADD_TRACEBACK(exception_tb, frame_49e1b7d0b4bc9978aeded24fde08fd2b, exception_lineno);
            SET_EXCEPTION_STATE_TRACEBACK(&exception_state, exception_tb);
        }
    }
    ...
    assertFrameObject(frame_49e1b7d0b4bc9978aeded24fde08fd2b);
